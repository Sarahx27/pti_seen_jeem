...
export const initialCategories: Category[] = [
  ...
  },
  {
    ...
    name: "قواعد البيانات",
    questions: [
      { id: 1, value: 100, text: "SQL؟", answer: "لغة استعلام بنيوية", used: false },
      { id: 2, value: 200, text: "SQL vs NoSQL؟", answer: "مخطط ثابت مقابل مرن", used: false },
      { id: 3, value: 300, text: "فهرسة؟", answer: "تسريع الاستعلام", used: false },
      { id: 4, value: 400, text: "ACID؟", answer: "اتومية، اتساق، عزل، ديمومة", used: false },
      { id: 5, value: 500, text: "Normalization؟", answer: "تقليل التكرار", used: false },
    ],
  },
  ...
  // 6) نظم التشغيل (جديدة)
  {
    ...
    name: "نظم التشغيل",
    questions: [
      { id: 1, value: 100, text: "Kernel؟", answer: "نواة النظام", used: false },
      { id: 2, value: 200, text: "Process vs Thread؟", answer: "عملية مقابل خيط", used: false },
      { id: 3, value: 300, text: "Concurrency؟", answer: "تشغيل متزامن للمهام", used: false },
      { id: 4, value: 400, text: "Virtual Memory؟", answer: "ذاكرة افتراضية", used: false },
      { id: 5, value: 500, text: "Scheduling؟", answer: "جدولة العمليات", used: false },
    ],
  },
